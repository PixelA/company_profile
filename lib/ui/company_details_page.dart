...
import 'company_intro_details_animation.dart';
import 'package:flutter/material.dart';
import 'package:meta/meta.dart';
import 'package:company_profile/ui/company_intro_details_animation.dart';
          ...
          children: <Widget>[
            CircleAvatar(
              ...
              child: new Image.asset(
                company.logo, width: 100.00, height: 100.0,),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text('Pixeldust Software Apps',
                style: TextStyle(
